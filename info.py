...
API_ID = int(environ.get('API_ID', '10483493'))
API_HASH = environ.get('API_HASH', '96f26d6c0c2aa53bf50c633f6065ee14')
BOT_TOKEN = environ.get('BOT_TOKEN', '6041303950:AAFnUaUZsRsyT-cXqHmy4FfBHAzAwNIlBXc')
# Bot settings
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5705624071').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kunapala:Kuna%407605900445@cluster0.2ywpiyd.mongodb.net/?retryWrites=true&w=majority")
...
# url shortner
SHORT_URL = environ.get("SHORT_URL",'tnshort.net')
SHORT_API = environ.get("SHORT_API",'29188678e9d94e8a0d7804748b3fe573fd137acc')
